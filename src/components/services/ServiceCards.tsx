                            ...
                            <div className="relative z-10 h-full flex items-center">
                                <div className={`flex items-center justify-between w-full px-12 md:px-16 ${index % 2 === 1 ? 'flex-row-reverse' : ''}`}>
                                    ...
                                    >
                                        <BlurText
                                            text={service.title}
                                            className={`text-4xl md:text-5xl lg:text-6xl font-bold ${service.textColor === 'white' ? 'text-white' : 'text-black'}`}
                                            blurAmount={20}
                                        ...
                                        {service.description && (
                                            <motion.p
                                                className={`text-base md:text-lg mt-4 max-w-md ${service.textColor === 'white' ? 'text-white' : 'text-black'} ${index % 2 === 1 ? 'ml-auto' : ''}`}
